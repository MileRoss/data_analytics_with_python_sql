...
-- 2. Get the number of accounts opened by district and year. Name the columns as: `District_name`, `Year` and `Accounts_opened`. Order the results by `District_name` and `Year`.
SELECT 
d.A2 AS District_name,
